...
class App(customtkinter.CTk):
    ...
    def saveAs(self): #saving function
    ...
    def run(self): #main funtion to run simulation
    ...
    def plot(self): #plotting function to generate plot
...
if __name__ == "__main__":
    app = App()
    try:
        app.mainloop() #running the App class windown loop
